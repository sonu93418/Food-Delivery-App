...
import {
  ...
  Animated, KeyboardAvoidingView, Platform, StatusBar, ActivityIndicator,
} from 'react-native';
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.content}>
        <Animated.View style={[styles.header, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          ...
          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>Sign in to continue ordering</Text>
        </Animated.View>
        ...
        <Animated.View style={[styles.form, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          ...
          <View style={styles.socialButtons}>
            <TouchableOpacity style={[styles.socialButton, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
            ...
            <TouchableOpacity style={[styles.socialButton, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
              <Ionicons name="logo-facebook" size={22} color={theme.text} />
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  circle: { position: 'absolute', borderRadius: 999, opacity: 0.07 },
  circle1: { width: 350, height: 350, backgroundColor: '#FF6B35', top: -100, right: -100 },
  circle2: { width: 250, height: 250, backgroundColor: '#e94560', bottom: -50, left: -80 },
  ...
  inputContainer: {
    ...
    height: 56, borderWidth: 1, gap: 12,
  },
